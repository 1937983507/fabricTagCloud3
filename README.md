...
![标签云效果图](./assets/标签云效果图.png)

### 2. 数据导入修改

![支持数据导入与修改](./assets/支持数据导入与修改.png)

### 3. 字体样式修改

![改字号字重字体](./assets/修改字号字重字体.png)

### 4. 配色修改

![修改配色](./assets/修改配色.png)

### 4. 多尺度变换

![粗略展示](./assets/粗略展示.png)
![精细展示](./assets/精细展示.png)
